...
public class BottomFlamedByDialog2 extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        flamedList = FirebaseFirestore.getInstance().collection(root + "/" + postID + "/commentL/" + docID + "/flameL/");
        ...
        dismiss.setOnClickListener(v1 -> BottomFlamedByDialog2.super.onDestroyView());
        return v;
    }
