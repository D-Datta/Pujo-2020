...
public class BottomFlamedByDialog2 extends BottomSheetDialogFragment {
...
//    private int currentItems, totalItems, scrollOutItems;
    ...
    public BottomFlamedByDialog2(String root, String postID, String docID){
        this.docID = docID;
        this.root = root;
        this.postID = postID;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(root.matches("Home")){
            flamedList = FirebaseFirestore.getInstance().collection("Feeds/"+postID+"/commentL/"+docID+"/flameL/");
        }
//        else if(root.matches("Events")){
//            flamedList = FirebaseFirestore.getInstance().collection(root+"/"+postCampus+"/Feeds/"+postID+"/commentL/"+docID+"/flameL/");
//        }
//        else if(root.matches("Sliders")){
//            flamedList = FirebaseFirestore.getInstance().collection(root+"/"+postCampus+"/Slides/"+postID+"/commentSL/"+docID+"/flameL/");
//        }
//        else {
//            flamedList = FirebaseFirestore.getInstance().collection(root+"/"+postCampus+"/Feeds/"+postID+"/commentL/"+docID+"/flameL/");
//        }

//        flamerecycler.addOnScrollListener(new RecyclerView.OnScrollListener() {
//            @Override
...
//                if(isScrolling && (currentItems + scrollOutItems == totalItems) && checkGetMore != -1) {
////                    progressBar.setVisibility(View.VISIBLE);
//                    isScrolling = false;
//                    fetchMore_flames();
//                }
...
//        }
        ...
        dismiss.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                BottomFlamedByDialog2.super.onDestroyView();
            }
        });
        return v;
    }
