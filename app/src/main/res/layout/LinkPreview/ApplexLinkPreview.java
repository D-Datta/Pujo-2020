package com.bytera.campus24.LinkPreview;
...
public class ApplexLinkPreview extends RelativeLayout {
    ...
    public ApplexLinkPreview(Context context) {
        super(context);
        this.context = context;
    }

    public ApplexLinkPreview(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public ApplexLinkPreview(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ApplexLinkPreview(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
