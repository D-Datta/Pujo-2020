...
//    private int currentItems, totalItems, scrollOutItems;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(root.matches("Home")){
            flamedList = FirebaseFirestore.getInstance().collection("Feeds/"+postID+"/commentL/"+pComID+"/commentL/"+docID+"/flameL/");
        }
//        else if(root.matches("Events")){
//            flamedList = FirebaseFirestore.getInstance().collection(root+"/"+postCampus+"/Feeds/"+postID+"/commentL/"+pComID+"/commentL/"+docID+"/flameL/");
//        }
//        else if(root.matches("Sliders")){
//            flamedList = FirebaseFirestore.getInstance().collection(root+"/"+postCampus+"/Slides/"+postID+"/commentSL/"+pComID+"/commentL/"+docID+"/flameL/");
//        }
//        else {
//            flamedList = FirebaseFirestore.getInstance().collection(root+"/"+postCampus+"/Feeds/"+postID+"/commentL/"+pComID+"/commentL/"+docID+"/flameL/");
//        }
...
//        }
        ...
        dismiss.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                BottomFlamedByDialog3.super.onDestroyView();
            }
        });
        return v;
    }
