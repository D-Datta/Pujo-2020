...
public class CommunityAdapter extends RecyclerView.Adapter<CommunityAdapter.ProgrammingViewHolder> {
    ...
    private ArrayList<CommunityModel> mList;
    Context mContext;
    int bool;
    public CommunityAdapter() {
    }

    public CommunityAdapter(ArrayList<CommunityModel> list, Context context, int bool) {
        this.mList = list;
    ...
    public void onBindViewHolder(@NonNull CommunityAdapter.ProgrammingViewHolder holder, int position) {
        CommunityModel currentitem = mList.get(position);
