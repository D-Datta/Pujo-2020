...
//        return new MaterialDialog.Builder(activity)
//                .customView(R.layout.lottie_anim_dialog1, false)
//                .build();
//    }
//
//    public MaterialDialog createAnimationDialog2(Activity activity) {
//        return new MaterialDialog.Builder(activity)
//                .customView(R.layout.lottie_anim_dialog2, false)
//                .build();
//    }
//
//    public MaterialDialog createAnimationDialog3(Activity activity) {
//        return new MaterialDialog.Builder(activity)
//                .customView(R.layout.lottie_anim_dialog3, false)
//                .build();
//    }

    public MaterialDialog createAnimationDialog4(Activity activity) {
        return new MaterialDialog.Builder(activity)
...
//        View view = LayoutInflater.from(activity).inflate(R.layout.lottie_anim_dialog1, null);
//
