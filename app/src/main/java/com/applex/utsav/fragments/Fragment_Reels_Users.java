...
public class Fragment_Reels_Users extends Fragment {
    ...
    public Fragment_Reels_Users() {
        // Required empty public constructor
    }

    public static Fragment_Reels_Users newInstance(String id) {
        Bundle args = new Bundle();
        args.putString("id", id);
        Fragment_Reels_Users f = new Fragment_Reels_Users();
        f.setArguments(args);
        return f;
    }

//    public Fragment_Reels_Users(String uid) {
//        this.uid = uid;
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment__reels__users, container, false);
    }
    ...
    private void buildRecyclerView() {
        ...
        adapter = new FirestorePagingAdapter<ReelsPostModel, Fragment_Reels.ProgrammingViewHolder>(options) {
            @NonNull
            @Override
            public Fragment_Reels.ProgrammingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
                View v = layoutInflater.inflate(R.layout.item_reels_committee, parent, false);
                return new Fragment_Reels.ProgrammingViewHolder(v);
            }

            @SuppressLint("SetTextI18n")
            @Override
            protected void onBindViewHolder(@NonNull Fragment_Reels.ProgrammingViewHolder holder, int position, @NonNull ReelsPostModel currentItem) {
