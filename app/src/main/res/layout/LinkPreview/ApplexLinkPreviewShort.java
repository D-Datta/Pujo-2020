...
public class ApplexLinkPreviewShort extends RelativeLayout {
    ...
    public ApplexLinkPreviewShort(Context context) {
        super(context);
        this.context = context;
    }

    public ApplexLinkPreviewShort(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public ApplexLinkPreviewShort(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ApplexLinkPreviewShort(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
